...
inject('pod', ({ HubContext, StateContext, BossContext }) => {
  inject('route', [
    '/server/:serverAddress/queue/:queueName/status/:status/page/:page/',
    p => () => {
      ...
      return (
        <div className='page'>
          <div className='split'>
            ...
            <AnchorButton icon='cross' large={true} minimal={true} href='/' />
          </div>
          <HTMLTable className='queues selectable' condensed={true}>
            ...
            <tbody>
              <tr>
                ...
                <td
                  onClick={e =>
                    page(`/server/${slugify(s.serverAddress)}/queue/${slugify(name)}/status/active/page/1/`)
                  }
                >
            ...
            <>
              <div className='split'>
                ...
                <div>
                  <AnchorButton
                    minimal={true}
                    className={`${pagination.hasprevpage ? '' : 'invisible'}`}
                    onClick={back}
                  >
                    Back
                  </AnchorButton>{' '}
                  ...
                  <AnchorButton
                    minimal={true}
                    className={`${pagination.hasnextpage ? '' : 'invisible'}`}
                    onClick={forward}
                  >
                    Forward
                  </AnchorButton>
                  ...
                  {jobState.jobs.map(j => {
                    ...
                    return (
                      <tr key={j.id}>
                        ...
                        <td title={j.id} onClick={e => navigator.clipboard.writeText(j.id)}>
                          {id_small}
                        </td>
                        <td title={j.activity_at} onClick={e => navigator.clipboard.writeText(j.activity_at)}>
                          {timeAgo(j.activity_at)}
                        </td>
                        <td
